...
from glean_agent_examples.examples.langchain.glean_search_retriever_server import LangchainGleanSearchExample


class GleanSearchRetrieverRunner(BaseExampleRunner):
    """
    Runner for the LangChain Glean Search Retriever example.
...
if __name__ == "__main__":
    ...
    runner = GleanSearchRetrieverRunner(example)
    ...
    try:
        ...
        runner.print_message('Usage: task run:example EXAMPLE=langchain/glean_search_retriever "What is your question?"')
        sys.exit(1)
